...
# call back for graph update everytime interval gets fired.


#________________________________call back_______________________________________________________________________________________
...
#reading all city to find user location


    df2 = pd.read_sql("select * from Twitterdb.tweet2", dbConnection2);
 
    df2 = pd.DataFrame(df2)
    df2['Created_at'] = pd.to_datetime(df2['Created_at']).apply(lambda x: x - datetime.timedelta(hours=7))
                     ...
                     #   figure = {
                       #     'data':[
                          ...
                          #          geojson="https://gist.githubusercontent.com/jbrobst/56c13bbbf9d97d187fea01ca62ea5112/raw/e388c4cae20aa53cb5090210a42ebb9b765c0a36/india_states.geojson",
                            ...
                            #        ],
                           # 'layout': {
                             #   'title': "Geographic Segmentation for India",
                              #  'geo':{'scope':"location"}
                        #    }
                       # }
                  #  )
